<template>
  <div class="box">
    ...
    <div class="minibox__header" @click="expandFilms = !expandFilms">
      Films
      <div class="toogle">
        <span v-if="!expandFilms">+</span>
        <span v-else>-</span>
      </div>
    </div>
    <div v-if="expandFilms" class="minibox__body">
    ...
    <div
      ...
      :class="{ 'mb-4': !expandPeople }"
      @click="expandPeople = !expandPeople"
    >
      Residents
      <div class="toogle">
    ...
    <div v-if="expandPeople" class="minibox__body mb-4">
